                                      ...
                                      4 ; This file was generated Sun May 01 17:29:51 2016
                                      5 ;--------------------------------------------------------
      ...
      000012 F5 38            [12]  364 	mov	(_Main_first_1_27 + 0x0005),a
                                    365 ;	assignment4.c:50: unsigned char second[] ={0,0,0,0,0,0};
      ...
      00001E F5 3E            [12]  377 	mov	(_Main_second_1_27 + 0x0005),a
                                    378 ;	assignment4.c:51: unsigned char final[] = {0,0,0,0,0,0};
      ...
      00002A F5 44            [12]  390 	mov	(_Main_final_1_27 + 0x0005),a
                                    391 ;	assignment4.c:53: unsigned char gotkey = 0;
      00002C 7C 00            [12]  392 	mov	r4,#0x00
                                    393 ;	assignment4.c:59: unsigned char keypad[4][3] = {   // This array contains the ASCII of the keypad keys
      ...
      00004F 75 50 2A         [24]  405 	mov	(_Main_keypad_1_27 + 0x000b),#0x2A
                                    406 ;	assignment4.c:68: functionSet();
      000052 C0 04            [24]  407 	push	ar4
      000054 12 02 05         [24]  408 	lcall	_functionSet
                                    409 ;	assignment4.c:69: entryModeSet(); // increment and no shift
      000057 12 01 BF         [24]  410 	lcall	_entryModeSet
      00005A D0 04            [24]  411 	pop	ar4
                                    412 ;	assignment4.c:70: displayOnOffControl(1, 1, 1); // display on, cursor on and blinking on
      ...
      000067 D0 04            [24]  418 	pop	ar4
                                    419 ;	assignment4.c:74: while(1){
      000069                        420 00116$:
                                    421 ;	assignment4.c:75: row = 0xf7;  // The first row (connected to P0.3) will be zero
      000069 7B F7            [12]  422 	mov	r3,#0xF7
                                    423 ;	assignment4.c:77: for (i=0;i<4;++i){ // loop over the 4 rows
      00006B 7A 00            [12]  424 	mov	r2,#0x00
      00006D 7D 00            [12]  425 	mov	r5,#0x00
      00006F                        426 00127$:
                                    427 ;	assignment4.c:79: P0 = 0xff;     // Initialize the 4 rows to '1' and set the column ports to inputs
      00006F 75 80 FF         [24]  428 	mov	_P0,#0xFF
                                    429 ;	assignment4.c:80: P0 = P0 & row; // clear one row at a time
      000072 EB               [12]  430 	mov	a,r3
      000073 52 80            [12]  431 	anl	_P0,a
                                    432 ;	assignment4.c:81: col = P0 & 0x70;  // Read the 3 columns
      000075 74 70            [12]  433 	mov	a,#0x70
      000077 55 80            [12]  434 	anl	a,_P0
      000079 FF               [12]  435 	mov	r7,a
                                    436 ;	assignment4.c:82: if (col != 0x70){ // If any column is zero i.e. a key is pressed
      00007A BF 70 02         [24]  437 	cjne	r7,#0x70,00172$
      00007D 80 1F            [24]  438 	sjmp	00102$
      00007F                        439 00172$:
                                    440 ;	assignment4.c:83: col = (~col) & 0x70;  // because the selected column returns zero
      ...
      000084 5E               [12]  445 	anl	a,r6
                                    446 ;	assignment4.c:84: col = col >> 5;       // The column variable now contain the number of the selected column
      000085 C4               [12]  447 	swap	a
      000086 03               [12]  448 	rr	a
      000087 54 07            [12]  449 	anl	a,#0x07
      000089 FF               [12]  450 	mov	r7,a
                                    451 ;	assignment4.c:85: gotkey = keypad[i][col]; // Get the ASCII of the corresponding pressed key
      ...
      000093 87 04            [24]  458 	mov	ar4,@r1
                                    459 ;	assignment4.c:86: big_delay();
      000095 C0 04            [24]  460 	push	ar4
      000097 12 02 70         [24]  461 	lcall	_big_delay
      00009A D0 04            [24]  462 	pop	ar4
                                    463 ;	assignment4.c:87: break;  // Since a key was detected -> Exit the for loop
      00009C 80 0F            [24]  464 	sjmp	00103$
      00009E                        465 00102$:
                                    466 ;	assignment4.c:89: row = row >> 1;   // No key is detected yet, try the next row
      00009E EB               [12]  467 	mov	a,r3
      00009F C3               [12]  468 	clr	c
      0000A0 13               [12]  469 	rrc	a
      0000A1 FB               [12]  470 	mov	r3,a
                                    471 ;	assignment4.c:90: row = row | 0xf0; // Only one of the least 4 significant bits is '0' at a time 	
      0000A2 43 03 F0         [24]  472 	orl	ar3,#0xF0
                                    473 ;	assignment4.c:77: for (i=0;i<4;++i){ // loop over the 4 rows
      ...
      0000D6 A6 04            [24]  513 	mov	@r0,ar4
                                    514 ;	assignment4.c:114: iterator = iterator+1;		
      ...
      0000EC A6 04            [24]  528 	mov	@r0,ar4
                                    529 ;	assignment4.c:119: iterator = iterator+1;
      ...
      000127 FF               [12]  563 	mov	r7,a
                                    564 ;	assignment4.c:130: while(hmm != 0) {
      ...
      00012E 60 56            [24]  570 	jz	00142$
                                    571 ;	assignment4.c:131: rem = hmm %10;
      ...
      00014F D0 07            [24]  586 	pop	ar7
                                    587 ;	assignment4.c:132: hmm = hmm / 10;
      ...
      000170 D0 05            [24]  602 	pop	ar5
                                    603 ;	assignment4.c:133: inter = (rem) + 48; 
      ...
      000178 FB               [12]  609 	mov	r3,a
                                    610 ;	assignment4.c:134: final[iterator] = inter; 
      ...
      00017D A7 02            [24]  614 	mov	@r1,ar2
                                    615 ;	assignment4.c:135: iterator = iterator+1;
      00017F 0C               [12]  616 	inc	r4
                                    617 ;	assignment4.c:138: while (iterator > -1){
      ...
      000197 50 18            [24]  632 	jnc	00125$
                                    633 ;	assignment4.c:139: sendChar(final[iterator]);
      ...
      0001B1 80 FE            [24]  651 	sjmp	00125$
                                    ...
                                    655 ;------------------------------------------------------------
                                    656 ;	assignment4.c:149: void returnHome(void) {
                                    657 ;	-----------------------------------------
      ...
      00021A 02 02 70         [24]  799 	ljmp	_big_delay
                                    ...
                                    804 ;------------------------------------------------------------
                                    805 ;	assignment4.c:210: void setDdRamAddress(char address) {  // Determine the place to place the next character - First LCD location address in 00h for line 1 and 40h for line 2
                                    806 ;	-----------------------------------------
                                    807 ;	 function setDdRamAddress
                                    808 ;	-----------------------------------------
      00021D                        809 _setDdRamAddress:
      00021D AF 82            [24]  810 	mov	r7,dpl
                                    811 ;	assignment4.c:211: RS = 0;
      00021F C2 B3            [12]  812 	clr	_P3_3
                                    813 ;	assignment4.c:212: P1 = address | 0x80;  // set the MSB to detect that this is an address
      000221 74 80            [12]  814 	mov	a,#0x80
      000223 4F               [12]  815 	orl	a,r7
      000224 F5 90            [12]  816 	mov	_P1,a
                                    817 ;	assignment4.c:213: E = 1;
      000226 D2 B2            [12]  818 	setb	_P3_2
                                    819 ;	assignment4.c:214: E = 0;
      000228 C2 B2            [12]  820 	clr	_P3_2
                                    821 ;	assignment4.c:215: delay();
      00022A 02 02 67         [24]  822 	ljmp	_delay
                                    ...
                                    827 ;------------------------------------------------------------
                                    828 ;	assignment4.c:220: void sendChar(char c) {  // Function to send one character to be displayed on the LCD
                                    829 ;	-----------------------------------------
                                    830 ;	 function sendChar
                                    831 ;	-----------------------------------------
      00022D                        832 _sendChar:
      00022D AF 82            [24]  833 	mov	r7,dpl
                                    834 ;	assignment4.c:221: RS = 1;
      00022F D2 B3            [12]  835 	setb	_P3_3
                                    836 ;	assignment4.c:222: P1 = c;
      000231 8F 90            [24]  837 	mov	_P1,r7
                                    838 ;	assignment4.c:223: E = 1;
      000233 D2 B2            [12]  839 	setb	_P3_2
                                    840 ;	assignment4.c:224: E = 0;
      000235 C2 B2            [12]  841 	clr	_P3_2
                                    842 ;	assignment4.c:225: delay();
      000237 02 02 67         [24]  843 	ljmp	_delay
                                    ...
                                    849 ;------------------------------------------------------------
                                    850 ;	assignment4.c:228: void sendString(char* str) {  // Function to send a string of characters to be displayed on the lCD
                                    851 ;	-----------------------------------------
      ...
      00023E AF F0            [24]  857 	mov	r7,b
                                    858 ;	assignment4.c:230: while (c = *str++) {
      000240                        859 00101$:
      ...
      000251 60 13            [24]  870 	jz	00104$
                                    871 ;	assignment4.c:231: sendChar(c);
      ...
      000266 22               [24]  882 	ret
                                    ...
                                    887 ;------------------------------------------------------------
                                    888 ;	assignment4.c:235: void delay(void) {
                                    889 ;	-----------------------------------------
                                    890 ;	 function delay
                                    891 ;	-----------------------------------------
      000267                        892 _delay:
                                    893 ;	assignment4.c:237: for (c = 0; c < 50; c++);
      ...
      00026F 22               [24]  901 	ret
                                    ...
                                    906 ;------------------------------------------------------------
                                    907 ;	assignment4.c:240: void big_delay(void) {
                                    908 ;	-----------------------------------------
                                    909 ;	 function big_delay
                                    910 ;	-----------------------------------------
      000270                        911 _big_delay:
                                    912 ;	assignment4.c:242: for (c = 0; c < 255; c++);
