                                      ...
                                      4 ; This file was generated Sun May 01 17:26:12 2016
                                      5 ;--------------------------------------------------------
                                      6 	.module hw4
      ...
      000012 F5 38            [12]  364 	mov	(_Main_first_1_27 + 0x0005),a
                                    365 ;	hw4.c:50: unsigned char second[] ={0,0,0,0,0,0};
      ...
      00001E F5 3E            [12]  377 	mov	(_Main_second_1_27 + 0x0005),a
                                    378 ;	hw4.c:51: unsigned char final[] = {0,0,0,0,0,0};
      ...
      00002A F5 44            [12]  390 	mov	(_Main_final_1_27 + 0x0005),a
                                    391 ;	hw4.c:53: unsigned char gotkey = 0;
      00002C 7C 00            [12]  392 	mov	r4,#0x00
                                    393 ;	hw4.c:59: unsigned char keypad[4][3] = {   // This array contains the ASCII of the keypad keys
      ...
      00004F 75 50 2A         [24]  405 	mov	(_Main_keypad_1_27 + 0x000b),#0x2A
                                    406 ;	hw4.c:68: functionSet();
      000052 C0 04            [24]  407 	push	ar4
      000054 12 02 05         [24]  408 	lcall	_functionSet
                                    409 ;	hw4.c:69: entryModeSet(); // increment and no shift
      000057 12 01 BF         [24]  410 	lcall	_entryModeSet
      00005A D0 04            [24]  411 	pop	ar4
                                    412 ;	hw4.c:70: displayOnOffControl(1, 1, 1); // display on, cursor on and blinking on
      ...
      000067 D0 04            [24]  418 	pop	ar4
                                    419 ;	hw4.c:74: while(1){
      000069                        420 00116$:
                                    421 ;	hw4.c:75: row = 0xf7;  // The first row (connected to P0.3) will be zero
      000069 7B F7            [12]  422 	mov	r3,#0xF7
                                    423 ;	hw4.c:77: for (i=0;i<4;++i){ // loop over the 4 rows
      00006B 7A 00            [12]  424 	mov	r2,#0x00
      00006D 7D 00            [12]  425 	mov	r5,#0x00
      00006F                        426 00127$:
                                    427 ;	hw4.c:79: P0 = 0xff;     // Initialize the 4 rows to '1' and set the column ports to inputs
      00006F 75 80 FF         [24]  428 	mov	_P0,#0xFF
                                    429 ;	hw4.c:80: P0 = P0 & row; // clear one row at a time
      000072 EB               [12]  430 	mov	a,r3
      000073 52 80            [12]  431 	anl	_P0,a
                                    432 ;	hw4.c:81: col = P0 & 0x70;  // Read the 3 columns
      000075 74 70            [12]  433 	mov	a,#0x70
      000077 55 80            [12]  434 	anl	a,_P0
      000079 FF               [12]  435 	mov	r7,a
                                    436 ;	hw4.c:82: if (col != 0x70){ // If any column is zero i.e. a key is pressed
      00007A BF 70 02         [24]  437 	cjne	r7,#0x70,00172$
      00007D 80 1F            [24]  438 	sjmp	00102$
      00007F                        439 00172$:
                                    440 ;	hw4.c:83: col = (~col) & 0x70;  // because the selected column returns zero
      ...
      000084 5E               [12]  445 	anl	a,r6
                                    446 ;	hw4.c:84: col = col >> 5;       // The column variable now contain the number of the selected column
      000085 C4               [12]  447 	swap	a
      000086 03               [12]  448 	rr	a
      000087 54 07            [12]  449 	anl	a,#0x07
      000089 FF               [12]  450 	mov	r7,a
                                    451 ;	hw4.c:85: gotkey = keypad[i][col]; // Get the ASCII of the corresponding pressed key
      ...
      000093 87 04            [24]  458 	mov	ar4,@r1
                                    459 ;	hw4.c:86: big_delay();
      000095 C0 04            [24]  460 	push	ar4
      000097 12 02 70         [24]  461 	lcall	_big_delay
      00009A D0 04            [24]  462 	pop	ar4
                                    463 ;	hw4.c:87: break;  // Since a key was detected -> Exit the for loop
      00009C 80 0F            [24]  464 	sjmp	00103$
      00009E                        465 00102$:
                                    466 ;	hw4.c:89: row = row >> 1;   // No key is detected yet, try the next row
      00009E EB               [12]  467 	mov	a,r3
      00009F C3               [12]  468 	clr	c
      0000A0 13               [12]  469 	rrc	a
      0000A1 FB               [12]  470 	mov	r3,a
                                    471 ;	hw4.c:90: row = row | 0xf0; // Only one of the least 4 significant bits is '0' at a time 	
      0000A2 43 03 F0         [24]  472 	orl	ar3,#0xF0
                                    473 ;	hw4.c:77: for (i=0;i<4;++i){ // loop over the 4 rows
      ...
      0000D6 A6 04            [24]  513 	mov	@r0,ar4
                                    514 ;	hw4.c:114: iterator = iterator+1;		
      ...
      0000EC A6 04            [24]  528 	mov	@r0,ar4
                                    529 ;	hw4.c:119: iterator = iterator+1;
      ...
      000178 FB               [12]  609 	mov	r3,a
                                    610 ;	hw4.c:134: final[iterator] = inter; 
      ...
      00017D A7 02            [24]  614 	mov	@r1,ar2
                                    615 ;	hw4.c:135: iterator = iterator+1;
      00017F 0C               [12]  616 	inc	r4
                                    617 ;	hw4.c:138: while (iterator > -1){
      ...
      000197 50 18            [24]  632 	jnc	00125$
                                    633 ;	hw4.c:139: sendChar(final[iterator]);
      ...
      0001B1 80 FE            [24]  651 	sjmp	00125$
                                    ...
                                    655 ;------------------------------------------------------------
                                    656 ;	hw4.c:149: void returnHome(void) {
                                    657 ;	-----------------------------------------
      ...
      0001E5 02 02 67         [24]  729 	ljmp	_delay
                                    ...
                                    732 ;------------------------------------------------------------
                                    733 ;	hw4.c:179: void cursorOrDisplayShift(__bit sc, __bit rl) {
                                    734 ;	-----------------------------------------
      ...
      000202 02 02 67         [24]  763 	ljmp	_delay
                                    ...
                                    766 ;------------------------------------------------------------
                                    767 ;	hw4.c:194: void functionSet(void) {
                                    768 ;	-----------------------------------------
      ...
      000205 C2 B3            [12]  773 	clr	_P3_3
                                    774 ;	hw4.c:196: P1 = 0x38; // 8-bit mode, 2 lines LCD
      ...
      00020E 02 02 67         [24]  781 	ljmp	_delay
                                    ...
                                    784 ;------------------------------------------------------------
                                    785 ;	hw4.c:202: void clearDisplay(void) {
                                    786 ;	-----------------------------------------
      ...
      000211 C2 B3            [12]  791 	clr	_P3_3
                                    792 ;	hw4.c:204: P1 = 0x01; // command to clear LCD and return the cursor to the home position
      000213 75 90 01         [24]  793 	mov	_P1,#0x01
                                    794 ;	hw4.c:205: E = 1;
      000216 D2 B2            [12]  795 	setb	_P3_2
                                    796 ;	hw4.c:206: E = 0;
      000218 C2 B2            [12]  797 	clr	_P3_2
                                    798 ;	hw4.c:207: big_delay(); // This operation needs a bigger delay
      00021A 02 02 70         [24]  799 	ljmp	_big_delay
                                    ...
                                    804 ;------------------------------------------------------------
                                    805 ;	hw4.c:210: void setDdRamAddress(char address) {  // Determine the place to place the next character - First LCD location address in 00h for line 1 and 40h for line 2
                                    806 ;	-----------------------------------------
      ...
      00021F C2 B3            [12]  812 	clr	_P3_3
                                    813 ;	hw4.c:212: P1 = address | 0x80;  // set the MSB to detect that this is an address
      ...
      00022A 02 02 67         [24]  822 	ljmp	_delay
                                    ...
                                    827 ;------------------------------------------------------------
                                    828 ;	hw4.c:220: void sendChar(char c) {  // Function to send one character to be displayed on the LCD
                                    829 ;	-----------------------------------------
      ...
      000237 02 02 67         [24]  843 	ljmp	_delay
                                    ...
                                    849 ;------------------------------------------------------------
                                    850 ;	hw4.c:228: void sendString(char* str) {  // Function to send a string of characters to be displayed on the lCD
                                    851 ;	-----------------------------------------
      ...
      000266 22               [24]  882 	ret
                                    ...
                                    887 ;------------------------------------------------------------
                                    888 ;	hw4.c:235: void delay(void) {
                                    889 ;	-----------------------------------------
                                    890 ;	 function delay
                                    891 ;	-----------------------------------------
      000267                        892 _delay:
                                    893 ;	hw4.c:237: for (c = 0; c < 50; c++);
      ...
      00026F 22               [24]  901 	ret
                                    ...
                                    906 ;------------------------------------------------------------
                                    907 ;	hw4.c:240: void big_delay(void) {
                                    908 ;	-----------------------------------------
                                    909 ;	 function big_delay
                                    910 ;	-----------------------------------------
      000270                        911 _big_delay:
                                    912 ;	hw4.c:242: for (c = 0; c < 255; c++);
