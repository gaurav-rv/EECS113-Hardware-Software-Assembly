...
#define RS P2_3
#define E P2_2
//#define cursorGoTo(row, col) setDdRamAddress( ((row) == 0)? (col) : ((col) + 40) )
...
void Main (void) __naked {
	...
	//int ss, mm, hh, dd, mm , yy = 0;
	unsigned char Seconds[] ={0,0};
	unsigned char Minutes[] ={0,0};
	unsigned char Hours[] = {0,0};
	unsigned char Day[] ={0,0};
	unsigned char Month[] ={0,0};
	unsigned char Year[] = {0,0};
	//unsigned char i;
